...
///       MaterialApp(home: const HomePageWithPersistentSidebar())
///
/// Customize:
///   - Adjust the `wideBreakpoint` and sidebar width
///   - Replace navigation logic inside `_navigate` with your router solution
class HomePageWithPersistentSidebar extends StatelessWidget {
  const HomePageWithPersistentSidebar({super.key});
